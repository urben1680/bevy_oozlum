...
#[test]
fn forward_to_after_backward_query_none_to_end() {
    [
        Test {
            time_stamp: 1,
...
#[test]
fn forward_to_after_backward_query_forward() {
    [
        Test {
            time_stamp: 1,
            progress_current: Progress::Forward,
...
#[test]
fn forward_to_after_backward_query_forward_to_present() {
    [
        Test {
            time_stamp: 1,
            progress_current: Progress::Forward,
...
#[test]
fn forward_to_after_backward_query_forward_one_tick() {
    [
        Test {
            time_stamp: 1,
            progress_current: Progress::Forward,
...
#[test]
fn forward_to_after_backward_query_forward_two_ticks() {
    [
        Test {
            time_stamp: 1,
            progress_current: Progress::Forward,
...
#[test]
fn forward_to_after_backward_query_forward_to_too_many_ticks() {
    [
        Test {
            time_stamp: 1,
            progress_current: Progress::Forward,
...
#[test]
fn forward_to_after_backward_query_log_to_past() {
    [
        Test {
            time_stamp: 1,
            progress_current: Progress::Forward,
...
#[test]
fn forward_to_after_backward_query_log_to_present() {
    [
        Test {
            time_stamp: 1,
            progress_current: Progress::Forward,
...
#[test]
fn forward_to_after_backward_query_log_to_future() {
    [
        Test {
            time_stamp: 1,
            progress_current: Progress::Forward,
...
#[test]
fn forward_to_after_backward_query_log_to_too_many_ticks() {
    [
        Test {
            time_stamp: 1,
            progress_current: Progress::Forward,
...
#[test]
fn forward_to_after_backward_query_pause() {
    [
        Test {
            time_stamp: 1,
            progress_current: Progress::Forward,
...
#[test]
fn forward_to_after_forward_query_forward() {
    [
        Test {
            time_stamp: 1,
            progress_current: Progress::Forward,
...
#[test]
fn forward_to_after_forward_query_forward_to_present() {
    [
        Test {
            time_stamp: 1,
            progress_current: Progress::Forward,
...
#[test]
fn forward_to_after_forward_query_forward_one_tick() {
    [
        Test {
            time_stamp: 1,
            progress_current: Progress::Forward,
...
#[test]
fn forward_to_after_forward_query_forward_two_ticks() {
    [
        Test {
            time_stamp: 1,
            progress_current: Progress::Forward,
...
#[test]
fn forward_to_after_forward_query_forward_to_too_many_ticks() {
    [
        Test {
            time_stamp: 1,
            progress_current: Progress::Forward,
...
#[test]
fn forward_to_after_forward_query_log_to_past() {
    [
        Test {
            time_stamp: 1,
            progress_current: Progress::Forward,
...
#[test]
fn forward_to_after_forward_query_log_to_present() {
    [
        Test {
            time_stamp: 1,
            progress_current: Progress::Forward,
...
#[test]
fn forward_to_after_forward_query_log_to_future() {
    [
        Test {
            time_stamp: 1,
            progress_current: Progress::Forward,
...
#[test]
fn forward_to_after_forward_query_log_to_too_many_ticks() {
    [
        Test {
            time_stamp: 1,
            progress_current: Progress::Forward,
    ...
    .run(Err(ProgressQueryError::QueryOutOfRange(
        Wrapping(0)..=Wrapping(2),
    )));
}

#[test]
fn forward_to_after_forward_query_pause() {
    [
        Test {
            time_stamp: 1,
            progress_current: Progress::Forward,
