...
const FOUR_FORWARD_ONE_BACKWARD_ZERO_FORWARD: [Option<ProgressQuery>; 6] = [
    None,
    None,
    None,
    Some(ProgressQuery::BackwardLog),
    Some(ProgressQuery::Forward),
    None //LogClose
];

const STEP_7_AFTER_FIRST_CHECK: DebugLog = DebugLog {
...
const STEP_7_AFTER_LAST_CHECK: DebugLog = DebugLog {
    progress_current: Progress::Forward { after_forward: true },
    ..STEP_7_AFTER_FIRST_CHECK
};
...
fn processes_none_query() {
    tests(
        ...
        FOUR_FORWARD_ONE_BACKWARD_ZERO_FORWARD,
        [Test {
            after_first_check: DebugLog {
                progress_query: None,
                ..STEP_7_AFTER_FIRST_CHECK
            },
            after_last_check: STEP_7_AFTER_LAST_CHECK,
            ..Default::default()
        }],
    );
}
...
fn processes_query_log_to_invalid() {
    tests(
        ...
        [Test {
            ...
            after_last_check: STEP_7_AFTER_FIRST_CHECK,
            ..Default::default()
        }],
    );
}
