...
#[test]
fn forward_log_after_forward_query_none_to_end() {
    [
        Test {
            time_stamp: Some(1),
...
#[test]
fn forward_log_after_forward_query_forward() {
    [
        Test {
            time_stamp: Some(1),
            progress_current: Progress::Forward,
...
#[test]
fn forward_log_after_forward_query_forward_to_present() {
    [
        Test {
            time_stamp: Some(1),
            progress_current: Progress::Forward,
...
#[test]
fn forward_log_after_forward_query_forward_one_tick() {
    [
        Test {
            time_stamp: Some(1),
            progress_current: Progress::Forward,
...
#[test]
fn forward_log_after_forward_query_forward_two_ticks() {
    [
        Test {
            time_stamp: Some(1),
            progress_current: Progress::Forward,
...
#[test]
fn forward_log_after_forward_query_forward_to_too_many_ticks() {
    [
        Test {
            time_stamp: Some(1),
            progress_current: Progress::Forward,
        ...
        Test {
            ...
            progress_query: Some(ProgressQuery::ForwardFastTo(Wrapping(5))),
            commands: vec![Command::Redo],
        },
    ]
    .run(Err(ProgressQueryError::QueryOutOfRange(
...
#[test]
fn forward_log_after_forward_query_forward_log_at_end() {
    [
        Test {
            time_stamp: Some(1),
            progress_current: Progress::Forward,
...
#[test]
fn forward_log_after_forward_query_forward_log_not_at_end() {
    [
        Test {
            time_stamp: Some(1),
            progress_current: Progress::Forward,
...
#[test]
fn forward_log_after_forward_query_backward_log(){
    [
        Test {
            time_stamp: Some(1),
            progress_current: Progress::Forward,
...
#[test]
fn forward_log_after_forward_query_log_to_past() {
    [
        Test {
            time_stamp: Some(1),
            progress_current: Progress::Forward,
...
#[test]
fn forward_log_after_forward_query_log_to_present() {
    [
        Test {
            time_stamp: Some(1),
            progress_current: Progress::Forward,
...
#[test]
fn forward_log_after_forward_query_log_to_future() {
    [
        Test {
            time_stamp: Some(1),
            progress_current: Progress::Forward,
        ...
        Test {
            ...
            progress_query: Some(ProgressQuery::LogFastTo(Wrapping(3))),
            commands: vec![Command::Redo],
        },
        Test {
            time_stamp: Some(3),
...
#[test]
fn forward_log_after_forward_query_log_to_too_many_ticks() {
    [
        Test {
            time_stamp: Some(1),
            progress_current: Progress::Forward,
...
#[test]
fn forward_log_after_forward_query_pause() {
    [
        Test {
            time_stamp: Some(1),
            progress_current: Progress::Forward,
