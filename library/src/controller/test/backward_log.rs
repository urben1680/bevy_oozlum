...
const ONE_FORWARD_THEN_BACK_QUERY: [TestControl; 1] = [
    TestControl {
        progress_query: Some(Progress::BackwardLog),
        time_step_query: None,
    }
    ...
    Test::tests(
        ...
        vec![
            Test {
                //test_index: 0
                control: TestControl {
                    progress_query: Some(Progress::ForwardFast { to_time_stamp: Wrapping(1) }),
                    time_step_query: None,
                },
                assert_at_update: Box::new(TestAssert {
                    progress: Progress::BackwardLog,
    ...
    Test::tests(
        ...
        vec![
            Test {
                //test_index: 0
                control: TestControl {
                    progress_query: Some(Progress::ForwardFast { to_time_stamp: Wrapping(2) }),
                    time_step_query: None,
                },
                assert_at_update: Box::new(TestAssert {
                    progress: Progress::BackwardLog,
    ...
    Test::tests(
        ...
        vec![
            Test {
                //test_index: 0
                control: TestControl {
                    progress_query: Some(Progress::ForwardFast { to_time_stamp: Wrapping(3) }),
                    time_step_query: None,
                },
                assert_at_update: Box::new(TestAssert {
                    progress: Progress::BackwardLog,
                ...
                assert_at_end: Box::new(TestAssert {
                    progress: Progress::ForwardFast { to_time_stamp: Wrapping(3) },
                    progress_query: None,
                    log_len: 2,
                    log_index: 1,
                    time_stamp: 1,
